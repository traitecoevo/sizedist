...
namespace model_model1c_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'model1c', line 23, column 2 to column 20)",
                                                      " (in 'model1c', line 24, column 2 to column 20)",
                                                      " (in 'model1c', line 25, column 2 to column 20)",
                                                      " (in 'model1c', line 26, column 2 to column 27)",
                                                      " (in 'model1c', line 29, column 18 to column 26)",
                                                      " (in 'model1c', line 29, column 2 to column 28)",
                                                      " (in 'model1c', line 30, column 16 to column 24)",
                                                      " (in 'model1c', line 30, column 2 to column 26)",
                                                      " (in 'model1c', line 32, column 2 to column 25)",
                                                      " (in 'model1c', line 33, column 2 to column 25)",
                                                      " (in 'model1c', line 34, column 2 to column 25)",
                                                      " (in 'model1c', line 35, column 2 to column 40)",
                                                      " (in 'model1c', line 38, column 4 to line 39, column 86)",
                                                      " (in 'model1c', line 37, column 23 to line 40, column 3)",
                                                      " (in 'model1c', line 37, column 2 to line 40, column 3)",
                                                      " (in 'model1c', line 41, column 2 to column 31)",
                                                      " (in 'model1c', line 44, column 4 to column 35)",
                                                      " (in 'model1c', line 43, column 23 to line 45, column 3)",
                                                      " (in 'model1c', line 43, column 2 to line 45, column 3)",
                                                      " (in 'model1c', line 47, column 2 to column 42)",
                                                      " (in 'model1c', line 4, column 2 to column 15)",
                                                      " (in 'model1c', line 5, column 2 to column 13)",
                                                      " (in 'model1c', line 6, column 17 to column 25)",
                                                      " (in 'model1c', line 6, column 2 to column 27)",
                                                      " (in 'model1c', line 7, column 17 to column 25)",
                                                      " (in 'model1c', line 7, column 2 to column 27)",
                                                      " (in 'model1c', line 8, column 13 to column 21)",
                                                      " (in 'model1c', line 8, column 2 to column 23)",
                                                      " (in 'model1c', line 10, column 2 to column 24)",
                                                      " (in 'model1c', line 11, column 9 to column 17)",
                                                      " (in 'model1c', line 11, column 2 to column 23)",
                                                      " (in 'model1c', line 12, column 9 to column 17)",
                                                      " (in 'model1c', line 12, column 2 to column 28)",
                                                      " (in 'model1c', line 14, column 2 to column 12)",
                                                      " (in 'model1c', line 15, column 2 to column 12)",
                                                      " (in 'model1c', line 16, column 2 to column 12)",
                                                      " (in 'model1c', line 17, column 2 to column 12)",
                                                      " (in 'model1c', line 18, column 2 to column 12)",
                                                      " (in 'model1c', line 19, column 2 to column 12)",
                                                      " (in 'model1c', line 20, column 2 to column 21)"};
#include <stan_meta_header.hpp>
class model_model1c final : public model_base_crtp<model_model1c> {
private:
  int N_counts;
  double s0_av;
...
public:
  ...
  inline std::string model_name() const final { return "model_model1c"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_model1c(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_model1c_namespace::model_model1c";
    ...
    try {
      ...
      context__.validate_dims("data initialization","s0_av","double",
          context__.to_vec());
      s0_av = std::numeric_limits<double>::quiet_NaN();
      
      current_statement__ = 22;
      s0_av = context__.vals_r("s0_av")[(1 - 1)];
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_model1c_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      if (jacobian__) {
        current_statement__ = 1;
        Z = stan::math::lb_constrain(Z, 0, lp__);
      } else {
        current_statement__ = 1;
        Z = stan::math::lb_constrain(Z, 0);
      }
      local_scalar_t__ R;
      R = DUMMY_VAR__;
      ...
      if (jacobian__) {
        current_statement__ = 3;
        g = stan::math::lb_constrain(g, 0, lp__);
      } else {
        current_statement__ = 3;
        g = stan::math::lb_constrain(g, 0);
      }
      ...
      }
      {
        ...
        lp_accum__.add(cauchy_lpdf<propto__>(Z, Z_mu, Z_sd));
        current_statement__ = 10;
        lp_accum__.add(cauchy_lpdf<propto__>(g, g_mu, g_sd));
        current_statement__ = 11;
        lp_accum__.add(cauchy_lpdf<propto__>(R, R_mu, R_sd));
        ...
        for (int i = 1; i <= N_counts; ++i) {
          ...
          assign(counts_est, cons_list(index_uni(i), nil_index_list()),
            ((-R / Z) *
              (stan::math::exp(((-Z / g) * (bin_upper[(i - 1)] - s0_av))) -
                stan::math::exp(((-Z / g) * (bin_lower[(i - 1)] - s0_av))))),
        ...
        for (int i = 1; i <= N_growth; ++i) {
          ...
          assign(size_est, cons_list(index_uni(i), nil_index_list()),
            (s0_av + (age[(i - 1)] * g)), "assigning variable size_est");}
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_model1c_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
  ...
  inline void transform_inits_impl(const stan::io::var_context& context__,
    ...
    try {
      ...
      current_statement__ = 1;
      Z_free__ = stan::math::lb_free(Z, 0);
      double R;
      R = std::numeric_limits<double>::quiet_NaN();
      ...
      current_statement__ = 3;
      g_free__ = stan::math::lb_free(g, 0);
      double sigma_size;
      sigma_size = std::numeric_limits<double>::quiet_NaN();
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"Z\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"R\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"g\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sigma_size\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"}]";
    return s__.str();
...
using stan_model = model_model1c_namespace::model_model1c;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_model1c_namespace::profiles__;
}
#endif
#endif
