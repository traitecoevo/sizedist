...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_model1c");
    reader.add_event(62, 60, "end", "model_model1c");
    return reader;
}
#include <stan_meta_header.hpp>
class model_model1c
  : public stan::model::model_base_crtp<model_model1c> {
private:
        int N_counts;
        double s0_av;
...
typedef model_model1c_namespace::model_model1c stan_model;
#ifndef USING_R
