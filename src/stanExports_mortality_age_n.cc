...
#include "stanExports_mortality_age_n.h"

RCPP_MODULE(stan_fit4mortality_age_n_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_mortality_age_n")
