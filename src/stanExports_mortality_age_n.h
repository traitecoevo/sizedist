...
namespace model_mortality_age_n_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mortality_age_n");
    reader.add_event(31, 29, "end", "model_mortality_age_n");
    return reader;
}
#include <stan_meta_header.hpp>
class model_mortality_age_n
  : public stan::model::model_base_crtp<model_mortality_age_n> {
private:
        int n;
...
public:
    model_mortality_age_n(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_mortality_age_n_namespace::model_mortality_age_n";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_mortality_age_n_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_mortality_age_n_namespace::model_mortality_age_n stan_model;
#ifndef USING_R
