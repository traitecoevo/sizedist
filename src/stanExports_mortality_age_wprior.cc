...
#include "stanExports_mortality_age_wprior.h"

RCPP_MODULE(stan_fit4mortality_age_wprior_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_mortality_age_wprior")
