...
namespace model_model1d_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_model1d");
    reader.add_event(65, 63, "end", "model_model1d");
    return reader;
}
#include <stan_meta_header.hpp>
class model_model1d
  : public stan::model::model_base_crtp<model_model1d> {
private:
        int N_counts;
...
public:
    model_model1d(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_model1d_namespace::model_model1d";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "N_growth", "int", context__.to_vec());
            N_growth = int(0);
            vals_i__ = context__.vals_i("N_growth");
            pos__ = 0;
            N_growth = vals_i__[pos__++];
            check_greater_or_equal(function__, "N_growth", N_growth, 0);
            current_statement_begin__ = 14;
            validate_non_negative_index("age", "N_growth", N_growth);
            context__.validate_dims("data initialization", "age", "vector_d", context__.to_vec(N_growth));
            age = Eigen::Matrix<double, Eigen::Dynamic, 1>(N_growth);
            vals_r__ = context__.vals_r("age");
            pos__ = 0;
            size_t age_j_1_max__ = N_growth;
            ...
            context__.validate_dims("data initialization", "size_ind", "vector_d", context__.to_vec(N_growth));
            size_ind = Eigen::Matrix<double, Eigen::Dynamic, 1>(N_growth);
            vals_r__ = context__.vals_r("size_ind");
            pos__ = 0;
            size_t size_ind_j_1_max__ = N_growth;
            for (size_t j_1__ = 0; j_1__ < size_ind_j_1_max__; ++j_1__) {
                size_ind(j_1__) = vals_r__[pos__++];
            }
            current_statement_begin__ = 18;
            context__.validate_dims("data initialization", "Z_mu", "double", context__.to_vec());
            Z_mu = double(0);
            ...
            context__.validate_dims("data initialization", "g_mu", "double", context__.to_vec());
            g_mu = double(0);
            vals_r__ = context__.vals_r("g_mu");
            pos__ = 0;
            g_mu = vals_r__[pos__++];
            current_statement_begin__ = 21;
            context__.validate_dims("data initialization", "g_sd", "double", context__.to_vec());
            g_sd = double(0);
            vals_r__ = context__.vals_r("g_sd");
            pos__ = 0;
            g_sd = vals_r__[pos__++];
            current_statement_begin__ = 22;
            context__.validate_dims("data initialization", "R_mu", "double", context__.to_vec());
            R_mu = double(0);
            vals_r__ = context__.vals_r("R_mu");
            pos__ = 0;
            R_mu = vals_r__[pos__++];
            ...
            context__.validate_dims("data initialization", "s0_mu", "double", context__.to_vec());
            s0_mu = double(0);
            vals_r__ = context__.vals_r("s0_mu");
            pos__ = 0;
            s0_mu = vals_r__[pos__++];
            ...
            context__.validate_dims("data initialization", "sigma_size_sd", "double", context__.to_vec());
            sigma_size_sd = double(0);
            vals_r__ = context__.vals_r("sigma_size_sd");
            pos__ = 0;
            sigma_size_sd = vals_r__[pos__++];
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "s0", "double", context__.to_vec());
        double s0(0);
        s0 = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, s0);
        } catch (const std::exception& e) {
        ...
        current_statement_begin__ = 34;
        if (!(context__.contains_r("sigma_size")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable sigma_size missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("sigma_size");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "sigma_size", "double", context__.to_vec());
        double sigma_size(0);
        sigma_size = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, sigma_size);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable sigma_size: ") + e.what()), current_statement_begin__, prog_reader__());
        }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                s0 = in__.scalar_lb_constrain(0, lp__);
            else
                s0 = in__.scalar_lb_constrain(0);
            current_statement_begin__ = 34;
            local_scalar_t__ sigma_size;
            (void) sigma_size;  // dummy to suppress unused var warning
            if (jacobian__)
                sigma_size = in__.scalar_lb_constrain(0, lp__);
            else
                sigma_size = in__.scalar_lb_constrain(0);
            // model body
            {
            ...
            std::vector<local_scalar_t__  > size_est(N_growth, local_scalar_t__(DUMMY_VAR__));
            stan::math::initialize(size_est, DUMMY_VAR__);
            stan::math::fill(size_est, DUMMY_VAR__);
            current_statement_begin__ = 43;
            lp_accum__.add(cauchy_log<propto__>(Z, Z_mu, Z_sd));
            current_statement_begin__ = 44;
            lp_accum__.add(cauchy_log<propto__>(g, g_mu, g_sd));
            current_statement_begin__ = 45;
            lp_accum__.add(cauchy_log<propto__>(R, R_mu, R_sd));
            current_statement_begin__ = 46;
            lp_accum__.add(cauchy_log<propto__>(s0, s0_mu, s0_sd));
            current_statement_begin__ = 47;
            lp_accum__.add(cauchy_log<propto__>(sigma_size, 0, sigma_size_sd));
            current_statement_begin__ = 50;
            for (int i = 1; i <= N_counts; ++i) {
                current_statement_begin__ = 51;
                stan::model::assign(counts_est, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            ((-(R) / Z) * (stan::math::exp(((-(Z) / g) * (get_base1(bin_upper, i, "bin_upper", 1) - s0))) - stan::math::exp(((-(Z) / g) * (get_base1(bin_lower, i, "bin_lower", 1) - s0))))), 
            ...
            for (int i = 1; i <= N_growth; ++i) {
                ...
                stan::model::assign(size_est, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            (s0 + (get_base1(age, i, "age", 1) * g)), 
                            "assigning variable size_est");
            }
            current_statement_begin__ = 62;
            lp_accum__.add(normal_log<propto__>(size_ind, size_est, sigma_size));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_model1d_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        vars__.push_back(g);
        double s0 = in__.scalar_lb_constrain(0);
        vars__.push_back(s0);
        double sigma_size = in__.scalar_lb_constrain(0);
        vars__.push_back(sigma_size);
        double lp__ = 0.0;
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "sigma_size";
        param_names__.push_back(param_name_stream__.str());
        if (!include_gqs__ && !include_tparams__) return;
...
typedef model_model1d_namespace::model_model1d stan_model;
#ifndef USING_R
