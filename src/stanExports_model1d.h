...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'model1d', line 24, column 2 to column 20)",
                                                      " (in 'model1d', line 25, column 2 to column 20)",
                                                      " (in 'model1d', line 26, column 2 to column 20)",
                                                      " (in 'model1d', line 27, column 2 to column 21)",
                                                      " (in 'model1d', line 28, column 2 to column 27)",
                                                      " (in 'model1d', line 31, column 18 to column 26)",
                                                      " (in 'model1d', line 31, column 2 to column 28)",
                                                      " (in 'model1d', line 32, column 16 to column 24)",
                                                      " (in 'model1d', line 32, column 2 to column 26)",
                                                      " (in 'model1d', line 34, column 2 to column 25)",
                                                      " (in 'model1d', line 35, column 2 to column 25)",
                                                      " (in 'model1d', line 36, column 2 to column 25)",
                                                      " (in 'model1d', line 37, column 2 to column 28)",
                                                      " (in 'model1d', line 38, column 2 to column 40)",
                                                      " (in 'model1d', line 41, column 4 to line 42, column 80)",
                                                      " (in 'model1d', line 40, column 23 to line 43, column 3)",
                                                      " (in 'model1d', line 40, column 2 to line 43, column 3)",
                                                      " (in 'model1d', line 44, column 2 to column 31)",
                                                      " (in 'model1d', line 47, column 4 to column 32)",
                                                      " (in 'model1d', line 46, column 23 to line 48, column 3)",
                                                      " (in 'model1d', line 46, column 2 to line 48, column 3)",
                                                      " (in 'model1d', line 50, column 2 to column 42)",
                                                      " (in 'model1d', line 4, column 2 to column 15)",
                                                      " (in 'model1d', line 5, column 17 to column 25)",
                                                      " (in 'model1d', line 5, column 2 to column 27)",
                                                      " (in 'model1d', line 6, column 17 to column 25)",
                                                      " (in 'model1d', line 6, column 2 to column 27)",
                                                      " (in 'model1d', line 7, column 13 to column 21)",
                                                      " (in 'model1d', line 7, column 2 to column 23)",
                                                      " (in 'model1d', line 9, column 2 to column 24)",
                                                      " (in 'model1d', line 10, column 9 to column 17)",
                                                      " (in 'model1d', line 10, column 2 to column 23)",
                                                      " (in 'model1d', line 11, column 9 to column 17)",
                                                      " (in 'model1d', line 11, column 2 to column 28)",
                                                      " (in 'model1d', line 13, column 2 to column 12)",
                                                      " (in 'model1d', line 14, column 2 to column 12)",
                                                      " (in 'model1d', line 15, column 2 to column 12)",
                                                      " (in 'model1d', line 16, column 2 to column 12)",
                                                      " (in 'model1d', line 17, column 2 to column 12)",
                                                      " (in 'model1d', line 18, column 2 to column 12)",
                                                      " (in 'model1d', line 19, column 2 to column 13)",
                                                      " (in 'model1d', line 20, column 2 to column 13)",
                                                      " (in 'model1d', line 21, column 2 to column 21)"};
#include <stan_meta_header.hpp>
class model_model1d final : public model_base_crtp<model_model1d> {
private:
  int N_counts;
...
public:
  ...
  inline std::string model_name() const final { return "model_model1d"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_model1d_namespace::log_prob";
(void) function__;  // suppress unused var warning
      ...
      }
      {
        ...
        for (int i = 1; i <= N_counts; ++i) {
          ...
          assign(counts_est, cons_list(index_uni(i), nil_index_list()),
            ((-R / Z) *
              (stan::math::exp(((-Z / g) * (bin_upper[(i - 1)] - s0))) -
                stan::math::exp(((-Z / g) * (bin_lower[(i - 1)] - s0))))),
        ...
        for (int i = 1; i <= N_growth; ++i) {
          ...
          assign(size_est, cons_list(index_uni(i), nil_index_list()),
            (s0 + (age[(i - 1)] * g)), "assigning variable size_est");}
...
using stan_model = model_model1d_namespace::model_model1d;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_model1d_namespace::profiles__;
}
#endif
#endif
