...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_model1e");
    reader.add_event(45, 43, "end", "model_model1e");
    return reader;
}
#include <stan_meta_header.hpp>
class model_model1e
  : public stan::model::model_base_crtp<model_model1e> {
private:
        int N_counts;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "c_mu", "double", context__.to_vec());
            c_mu = double(0);
            vals_r__ = context__.vals_r("c_mu");
            pos__ = 0;
            c_mu = vals_r__[pos__++];
            ...
            context__.validate_dims("data initialization", "b_mu", "double", context__.to_vec());
            b_mu = double(0);
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(lognormal_log<propto__>(c, c_mu, c_sd));
            current_statement_begin__ = 31;
            lp_accum__.add(lognormal_log<propto__>(b, b_mu, b_sd));
            current_statement_begin__ = 34;
            for (int i = 1; i <= N_counts; ++i) {
                current_statement_begin__ = 35;
                stan::model::assign(counts_est, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            ((c * (stan::math::exp((-(b) * get_base1(bin_lower, i, "bin_lower", 1))) / b)) - (stan::math::exp((-(b) * get_base1(bin_upper, i, "bin_upper", 1))) / b)), 
...
typedef model_model1e_namespace::model_model1e stan_model;
#ifndef USING_R
