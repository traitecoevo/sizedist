...
#include "stanExports_mortality_size_growth.h"

RCPP_MODULE(stan_fit4mortality_size_growth_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_mortality_size_growth")
