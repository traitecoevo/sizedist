...
namespace model_mortality_size_growth_wprior_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mortality_size_growth_wprior");
    reader.add_event(54, 52, "end", "model_mortality_size_growth_wprior");
    return reader;
}
#include <stan_meta_header.hpp>
class model_mortality_size_growth_wprior
  : public stan::model::model_base_crtp<model_mortality_size_growth_wprior> {
private:
        int N_counts;
        double s0_av;
        double Z_sd;
        ...
        vector_d size_ind;
public:
    model_mortality_size_growth_wprior(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_mortality_size_growth_wprior_namespace::model_mortality_size_growth_wprior";
    ...
    ~model_mortality_size_growth_wprior() { }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(cauchy_log<propto__>(g, 0, 10));
            current_statement_begin__ = 35;
            lp_accum__.add(cauchy_log<propto__>(R, 0, 100));
            current_statement_begin__ = 36;
            lp_accum__.add(cauchy_log<propto__>(sigma_size, 0, 2.5));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_mortality_size_growth_wprior_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_mortality_size_growth_wprior";
    }
...
typedef model_mortality_size_growth_wprior_namespace::model_mortality_size_growth_wprior stan_model;
#ifndef USING_R
