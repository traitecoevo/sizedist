...
namespace model_mortality_age_wprior_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mortality_age_wprior");
    reader.add_event(32, 30, "end", "model_mortality_age_wprior");
    return reader;
}
#include <stan_meta_header.hpp>
class model_mortality_age_wprior
  : public stan::model::model_base_crtp<model_mortality_age_wprior> {
private:
        int N_counts;
        ...
        double Z_sd;
public:
    model_mortality_age_wprior(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_mortality_age_wprior_namespace::model_mortality_age_wprior";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_mortality_age_wprior_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_mortality_age_wprior";
    }
...
typedef model_mortality_age_wprior_namespace::model_mortality_age_wprior stan_model;
#ifndef USING_R
