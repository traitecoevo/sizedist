...
namespace model_model1b_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'model1b', line 16, column 2 to column 20)",
                                                      " (in 'model1b', line 17, column 2 to column 20)",
                                                      " (in 'model1b', line 18, column 2 to column 20)",
                                                      " (in 'model1b', line 21, column 18 to column 26)",
                                                      " (in 'model1b', line 21, column 2 to column 28)",
                                                      " (in 'model1b', line 23, column 2 to column 25)",
                                                      " (in 'model1b', line 24, column 2 to column 28)",
                                                      " (in 'model1b', line 25, column 2 to column 25)",
                                                      " (in 'model1b', line 28, column 4 to line 29, column 86)",
                                                      " (in 'model1b', line 27, column 23 to line 30, column 3)",
                                                      " (in 'model1b', line 27, column 2 to line 30, column 3)",
                                                      " (in 'model1b', line 32, column 2 to column 31)",
                                                      " (in 'model1b', line 3, column 2 to column 15)",
                                                      " (in 'model1b', line 4, column 2 to column 13)",
                                                      " (in 'model1b', line 5, column 2 to column 12)",
                                                      " (in 'model1b', line 6, column 17 to column 25)",
                                                      " (in 'model1b', line 6, column 2 to column 27)",
                                                      " (in 'model1b', line 7, column 17 to column 25)",
                                                      " (in 'model1b', line 7, column 2 to column 27)",
                                                      " (in 'model1b', line 8, column 13 to column 21)",
                                                      " (in 'model1b', line 8, column 2 to column 23)",
                                                      " (in 'model1b', line 10, column 2 to column 12)",
                                                      " (in 'model1b', line 11, column 2 to column 12)",
                                                      " (in 'model1b', line 12, column 2 to column 12)",
                                                      " (in 'model1b', line 13, column 2 to column 12)"};
#include <stan_meta_header.hpp>
class model_model1b final : public model_base_crtp<model_model1b> {
private:
  int N_counts;
  double s0_av;
  double g_av;
...
public:
  ...
  inline std::string model_name() const final { return "model_model1b"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_model1b(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_model1b_namespace::model_model1b";
    ...
    try {
      ...
      context__.validate_dims("data initialization","g_av","double",
          context__.to_vec());
      g_av = std::numeric_limits<double>::quiet_NaN();
      
      current_statement__ = 15;
      g_av = context__.vals_r("g_av")[(1 - 1)];
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_model1b_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      }
      {
        ...
        lp_accum__.add(normal_lpdf<propto__>(g, g_av, 0.0001));
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_model1b_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"Z\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"R\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"g\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"}]";
    return s__.str();
...
using stan_model = model_model1b_namespace::model_model1b;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_model1b_namespace::profiles__;
}
#endif
#endif
