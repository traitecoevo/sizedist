...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_model1b");
    reader.add_event(43, 41, "end", "model_model1b");
    return reader;
}
#include <stan_meta_header.hpp>
class model_model1b
  : public stan::model::model_base_crtp<model_model1b> {
private:
        int N_counts;
        double s0_av;
        double g_av;
...
typedef model_model1b_namespace::model_model1b stan_model;
#ifndef USING_R
