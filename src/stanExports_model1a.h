...
namespace model_model1a_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'model1a', line 14, column 2 to column 20)",
                                                      " (in 'model1a', line 15, column 2 to column 20)",
                                                      " (in 'model1a', line 18, column 18 to column 26)",
                                                      " (in 'model1a', line 18, column 2 to column 28)",
                                                      " (in 'model1a', line 20, column 2 to column 25)",
                                                      " (in 'model1a', line 21, column 2 to column 25)",
                                                      " (in 'model1a', line 24, column 6 to column 77)",
                                                      " (in 'model1a', line 23, column 22 to line 25, column 3)",
                                                      " (in 'model1a', line 23, column 2 to line 25, column 3)",
                                                      " (in 'model1a', line 27, column 2 to column 31)",
                                                      " (in 'model1a', line 3, column 2 to column 15)",
                                                      " (in 'model1a', line 4, column 17 to column 25)",
                                                      " (in 'model1a', line 4, column 2 to column 27)",
                                                      " (in 'model1a', line 5, column 17 to column 25)",
                                                      " (in 'model1a', line 5, column 2 to column 27)",
                                                      " (in 'model1a', line 6, column 13 to column 21)",
                                                      " (in 'model1a', line 6, column 2 to column 23)",
                                                      " (in 'model1a', line 8, column 2 to column 12)",
                                                      " (in 'model1a', line 9, column 2 to column 12)",
                                                      " (in 'model1a', line 10, column 2 to column 12)",
                                                      " (in 'model1a', line 11, column 2 to column 12)"};
#include <stan_meta_header.hpp>
class model_model1a final : public model_base_crtp<model_model1a> {
private:
  int N_counts;
...
public:
  ...
  inline std::string model_name() const final { return "model_model1a"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_model1a(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_model1a_namespace::model_model1a";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_model1a_namespace::log_prob";
(void) function__;  // suppress unused var warning
      ...
      }
      {
        ...
        for (int i = 1; i <= N_counts; ++i) {
          ...
          assign(counts_est, cons_list(index_uni(i), nil_index_list()),
            ((-R / Z) *
              (stan::math::exp((-Z * bin_upper[(i - 1)])) -
                stan::math::exp((-Z * bin_lower[(i - 1)])))),
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_model1a_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"Z\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"R\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"}]";
    return s__.str();
...
using stan_model = model_model1a_namespace::model_model1a;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_model1a_namespace::profiles__;
}
#endif
#endif
