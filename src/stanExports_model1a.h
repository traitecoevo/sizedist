...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_model1a");
    reader.add_event(38, 36, "end", "model_model1a");
    return reader;
}
#include <stan_meta_header.hpp>
class model_model1a
  : public stan::model::model_base_crtp<model_model1a> {
private:
        int N_counts;
...
typedef model_model1a_namespace::model_model1a stan_model;
#ifndef USING_R
