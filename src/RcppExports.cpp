...
RcppExport SEXP _rcpp_module_boot_stan_fit4mortality_age_n_mod();
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_rcpp_module_boot_stan_fit4mortality_age_n_mod", (DL_FUNC) &_rcpp_module_boot_stan_fit4mortality_age_n_mod, 0},
