...
namespace model_mortality_size_known_g_namespace {
using std::istream;
using std::string;
...
class model_mortality_size_known_g
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_mortality_size_known_g_namespace::model_mortality_size_known_g";
        ...
        try {
            ...
            validate_non_negative_index("size_lower", "n", n);
            context__.validate_dims("data initialization", "size_lower", "double", context__.to_vec(n));
            size_lower = std::vector<double>(n, double(0));
            vals_r__ = context__.vals_r("size_lower");
            pos__ = 0;
            size_t size_lower_k_0_max__ = n;
            for (size_t k_0__ = 0; k_0__ < size_lower_k_0_max__; ++k_0__) {
                size_lower[k_0__] = vals_r__[pos__++];
            }
            current_statement_begin__ = 8;
            validate_non_negative_index("size_upper", "n", n);
            context__.validate_dims("data initialization", "size_upper", "double", context__.to_vec(n));
            size_upper = std::vector<double>(n, double(0));
            vals_r__ = context__.vals_r("size_upper");
            pos__ = 0;
            size_t size_upper_k_0_max__ = n;
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_mortality_size_known_g_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_mortality_size_known_g";
    }
...
typedef model_mortality_size_known_g_namespace::model_mortality_size_known_g stan_model;
#ifndef USING_R
