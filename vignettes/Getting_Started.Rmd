...
#### Estimating Growth, Mortality and size-at-hatch.

There is now a versions of model1 (`model1d`) which also estimates size-at-hatch `s0` from the size-at-age and size data using a similiar method to `model1c`. 
...
#### Estimating Slope of abundance spectra.
