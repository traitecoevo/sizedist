...
There is now another model (`model1c`) which also estimates size-at-hatch `s0` from the size-at-age and size data.
...
# Add in parameters to data list
standata_size_growth_mod4 <- standata_size_growth_mod3 %>% add_pars(pars_m_g)
